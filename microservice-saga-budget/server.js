...
log4js.configure({
    appenders: [
        ...
        },
        {
            ...
            category: 'saga-budget'
        }
    ]
});

var logger = log4js.getLogger('saga-budget');
...
const saga = require('cqrs-saga')({
    ...
    sagaStore: {
        ...
        port: 27017,                                // optional
        dbName: 'domain-saga-budget',             // optional
    ...
    revisionGuardStore: {
        ...
        port: 6379,                                 // optional
        db: 0,                                      // optional
        prefix: 'readmodel-saga-account-revision',  // optional
        timeout: 10000,                              // optional
...
denormalizer.init(function(err) {
    ...
    saga.init(function(err) {
        ...
        logger.trace('Starting Budget Saga Microservice'.cyan);
    });
});
